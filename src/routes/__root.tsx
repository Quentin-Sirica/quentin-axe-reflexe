...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Coach mental tennis & padel à Marseille | Axe-Réflexe" },
      ...
      { property: "og:title", content: "Coach mental tennis & padel à Marseille | Axe-Réflexe" },
      ...
      { name: "twitter:title", content: "Coach mental tennis & padel à Marseille | Axe-Réflexe" },
