...
const offers = [
  {
    ...
    duration: "15 minutes",
    price: "0€",
    desc: "On analyse votre besoin. Si vous n'êtes pas prêt à vous impliquer, je vous le dis cash. L'investissement est bilatéral.",
      ...
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-10 items-center relative">
        <div className="lg:col-span-7 space-y-8">
          ...
          <h1 className="font-display font-bold text-5xl sm:text-6xl lg:text-7xl leading-[0.95] text-balance">
            Il est temps <span className="text-primary">de piloter votre mental</span> face à la réalité du terrain
          </h1>
